...
const core: VocabCard[] = [
  ...
  { id: 'v007', no: 'en avtale', en: 'an appointment / agreement', type: 'substantiv', gender: 'en', example: 'Jeg har en avtale hos legen i morgen.', exampleEn: 'I have an appointment at the doctor’s tomorrow.', level: 'A2', topic: 'hverdagsliv' },
  ...
  { id: 'v011', no: 'et forhold', en: 'a relationship', type: 'substantiv', gender: 'et', example: 'De har et godt forhold til naboene.', exampleEn: 'They have a good relationship with the neighbours.', level: 'A2', topic: 'familie' },
  { id: 'v012', no: 'en samboer', en: 'a live-in partner (cohabitant)', type: 'substantiv', gender: 'en', example: 'Hun bor sammen med samboeren sin i Bergen.', exampleEn: 'She lives with her partner in Bergen.', level: 'A2', topic: 'familie' },
  ...
  { id: 'v014', no: 'et barnebarn', en: 'a grandchild', type: 'substantiv', gender: 'et', example: 'Bestemor passer barnebarna hver fredag.', exampleEn: 'Grandma looks after the grandchildren every Friday.', level: 'A2', topic: 'familie' },
  ...
  { id: 'v017', no: 'en nabo', en: 'a neighbour', type: 'substantiv', gender: 'en', example: 'Naboen min hjelper meg ofte med hagen.', exampleEn: 'My neighbour often helps me with the garden.', level: 'A2', topic: 'familie' },
  ...
  // ───────────────────────── A2 · mat og drikke ─────────────────────────
  { id: 'v019', no: 'et måltid', en: 'a meal', type: 'substantiv', gender: 'et', example: 'Middag er det viktigste måltidet for mange familier.', exampleEn: 'Dinner is the most important meal for many families.', level: 'A2', topic: 'mat' },
  ...
  { id: 'v024', no: 'et pålegg', en: 'a (bread) topping / spread', type: 'substantiv', gender: 'et', example: 'Brunost er et typisk norsk pålegg.', exampleEn: 'Brown cheese is a typical Norwegian bread topping.', level: 'A2', topic: 'mat' },

  // ───────────────────────── A2 · vær og natur ─────────────────────────
  { id: 'v025', no: 'et vær', en: 'weather', type: 'substantiv', gender: 'et', example: 'Det er fint vær i dag.', exampleEn: 'The weather is nice today.', level: 'A2', topic: 'natur' },
  ...
  { id: 'v029', no: 'en tur', en: 'a walk / trip / hike', type: 'substantiv', gender: 'en', example: 'Skal vi gå en tur i skogen?', exampleEn: 'Shall we go for a walk in the forest?', level: 'A2', topic: 'natur' },
  ...
  { id: 'v032', no: 'en billett', en: 'a ticket', type: 'substantiv', gender: 'en', example: 'Har du kjøpt billett til toget?', exampleEn: 'Have you bought a ticket for the train?', level: 'A2', topic: 'reise' },
  ...
  { id: 'v035', no: 'en holdeplass', en: 'a (bus) stop', type: 'substantiv', gender: 'en', example: 'Holdeplassen ligger rett ved butikken.', exampleEn: 'The bus stop is right by the shop.', level: 'A2', topic: 'reise' },

  // ───────────────────────── A2 · jobb ─────────────────────────
  { id: 'v036', no: 'en jobb', en: 'a job', type: 'substantiv', gender: 'en', example: 'Han har fått ny jobb i Oslo.', exampleEn: 'He has got a new job in Oslo.', level: 'A2', topic: 'jobb' },
  { id: 'v037', no: 'en kollega', en: 'a colleague', type: 'substantiv', gender: 'en', example: 'Kollegaene mine er veldig hyggelige.', exampleEn: 'My colleagues are very nice.', level: 'A2', topic: 'jobb' },
  { id: 'v038', no: 'en sjef', en: 'a boss', type: 'substantiv', gender: 'en', example: 'Sjefen min gir meg mye ansvar.', exampleEn: 'My boss gives me a lot of responsibility.', level: 'A2', topic: 'jobb' },
  { id: 'v039', no: 'en lønn', en: 'a salary / wage', type: 'substantiv', gender: 'en', example: 'Lønna blir utbetalt den femtende hver måned.', exampleEn: 'The salary is paid on the fifteenth of every month.', level: 'A2', topic: 'jobb' },
  { id: 'v040', no: 'et møte', en: 'a meeting', type: 'substantiv', gender: 'et', example: 'Vi har møte hver mandag morgen.', exampleEn: 'We have a meeting every Monday morning.', level: 'A2', topic: 'jobb' },
  ...
  // ───────────────────────── A2 · helse ─────────────────────────
  { id: 'v042', no: 'en lege', en: 'a doctor', type: 'substantiv', gender: 'en', example: 'Du bør bestille time hos legen.', exampleEn: 'You should book an appointment with the doctor.', level: 'A2', topic: 'helse' },
  ...
  { id: 'v045', no: 'et apotek', en: 'a pharmacy', type: 'substantiv', gender: 'et', example: 'Du kan hente medisinen på apoteket.', exampleEn: 'You can pick up the medicine at the pharmacy.', level: 'A2', topic: 'helse' },
  ...
  // ───────────────────────── A2 · bolig ─────────────────────────
  { id: 'v047', no: 'en leilighet', en: 'an apartment', type: 'substantiv', gender: 'en', example: 'De leier en leilighet i sentrum.', exampleEn: 'They rent an apartment in the city centre.', level: 'A2', topic: 'bolig' },
  ...
  { id: 'v051', no: 'et arbeidsliv', en: 'working life', type: 'substantiv', gender: 'et', example: 'Det norske arbeidslivet er preget av tillit.', exampleEn: 'Norwegian working life is characterised by trust.', level: 'B1', topic: 'jobb' },
  { id: 'v052', no: 'en erfaring', en: 'an experience', type: 'substantiv', gender: 'en', example: 'Hun har lang erfaring med kundeservice.', exampleEn: 'She has long experience with customer service.', level: 'B1', topic: 'jobb' },
  { id: 'v053', no: 'et ansvar', en: 'a responsibility', type: 'substantiv', gender: 'et', example: 'Alle ansatte har ansvar for et godt arbeidsmiljø.', exampleEn: 'All employees are responsible for a good working environment.', level: 'B1', topic: 'jobb' },
  ...
  { id: 'v055', no: 'en arbeidsgiver', en: 'an employer', type: 'substantiv', gender: 'en', example: 'Arbeidsgiveren må betale sykepenger de første dagene.', exampleEn: 'The employer must pay sick pay for the first days.', level: 'B1', topic: 'jobb' },
  { id: 'v056', no: 'en arbeidstaker', en: 'an employee', type: 'substantiv', gender: 'en', example: 'Arbeidstakere har rett til ferie hvert år.', exampleEn: 'Employees have the right to holiday every year.', level: 'B1', topic: 'jobb' },
  { id: 'v057', no: 'en fagforening', en: 'a trade union', type: 'substantiv', gender: 'en', example: 'Mange nordmenn er medlem av en fagforening.', exampleEn: 'Many Norwegians are members of a trade union.', level: 'B1', topic: 'jobb' },
  { id: 'v058', no: 'en søknad', en: 'an application', type: 'substantiv', gender: 'en', example: 'Jeg sendte en søknad, men fikk avslag.', exampleEn: 'I sent an application but was rejected.', level: 'B1', topic: 'jobb' },
  { id: 'v059', no: 'et intervju', en: 'an interview', type: 'substantiv', gender: 'et', example: 'Han ble innkalt til intervju uka etter.', exampleEn: 'He was called in for an interview the following week.', level: 'B1', topic: 'jobb' },
  ...
  { id: 'v062', no: 'en frist', en: 'a deadline', type: 'substantiv', gender: 'en', example: 'Fristen for å søke er første mars.', exampleEn: 'The application deadline is the first of March.', level: 'B1', topic: 'jobb' },
  ...
  { id: 'v064', no: 'et krav', en: 'a requirement / demand', type: 'substantiv', gender: 'et', example: 'Det er et krav om norskkunnskaper i mange yrker.', exampleEn: 'Norwegian skills are a requirement in many professions.', level: 'B1', topic: 'jobb' },

  // ───────────────────────── B1 · samfunn ─────────────────────────
  { id: 'v065', no: 'et samfunn', en: 'a society', type: 'substantiv', gender: 'et', example: 'Norge er et samfunn med små forskjeller.', exampleEn: 'Norway is a society with small differences.', level: 'B1', topic: 'samfunn' },
  { id: 'v066', no: 'en rettighet', en: 'a right', type: 'substantiv', gender: 'en', example: 'Alle barn har rett til utdanning.', exampleEn: 'All children have the right to education.', level: 'B1', topic: 'samfunn' },
  { id: 'v067', no: 'en plikt', en: 'a duty / obligation', type: 'substantiv', gender: 'en', example: 'Med rettigheter følger det også plikter.', exampleEn: 'With rights come duties as well.', level: 'B1', topic: 'samfunn' },
  { id: 'v068', no: 'et valg', en: 'an election / a choice', type: 'substantiv', gender: 'et', example: 'Det er stortingsvalg hvert fjerde år.', exampleEn: 'There is a parliamentary election every four years.', level: 'B1', topic: 'samfunn' },
  ...
  { id: 'v070', no: 'en skatt', en: 'a tax', type: 'substantiv', gender: 'en', example: 'Vi betaler skatt for å finansiere velferdsstaten.', exampleEn: 'We pay tax to finance the welfare state.', level: 'B1', topic: 'samfunn' },
  { id: 'v071', no: 'en velferdsstat', en: 'a welfare state', type: 'substantiv', gender: 'en', example: 'Velferdsstaten gir alle rett til helsehjelp.', exampleEn: 'The welfare state gives everyone the right to healthcare.', level: 'B1', topic: 'samfunn' },
  ...
  { id: 'v073', no: 'en ytringsfrihet', en: 'freedom of speech', type: 'substantiv', gender: 'en', example: 'Ytringsfrihet er beskyttet av Grunnloven.', exampleEn: 'Freedom of speech is protected by the Constitution.', level: 'B1', topic: 'samfunn' },
  { id: 'v074', no: 'en kommune', en: 'a municipality', type: 'substantiv', gender: 'en', example: 'Kommunen har ansvar for skoler og barnehager.', exampleEn: 'The municipality is responsible for schools and kindergartens.', level: 'B1', topic: 'samfunn' },
  { id: 'v075', no: 'en innvandrer', en: 'an immigrant', type: 'substantiv', gender: 'en', example: 'Mange innvandrere lærer norsk på voksenopplæringen.', exampleEn: 'Many immigrants learn Norwegian at adult education.', level: 'B1', topic: 'samfunn' },
  { id: 'v076', no: 'et statsborgerskap', en: 'a citizenship', type: 'substantiv', gender: 'et', example: 'Hun søkte om norsk statsborgerskap i fjor.', exampleEn: 'She applied for Norwegian citizenship last year.', level: 'B1', topic: 'samfunn' },
  { id: 'v077', no: 'en lov', en: 'a law', type: 'substantiv', gender: 'en', example: 'Stortinget vedtar nye lover.', exampleEn: 'The Parliament passes new laws.', level: 'B1', topic: 'samfunn' },
  ...
  { id: 'v079', no: 'en dugnad', en: 'voluntary communal work', type: 'substantiv', gender: 'en', example: 'Borettslaget har dugnad hver vår.', exampleEn: 'The housing cooperative has communal work every spring.', level: 'B1', topic: 'samfunn' },
  ...
  { id: 'v084', no: 'en fordel', en: 'an advantage', type: 'substantiv', gender: 'en', example: 'En stor fordel med Norge er naturen.', exampleEn: 'A big advantage of Norway is the nature.', level: 'B1', topic: 'meninger' },
  { id: 'v085', no: 'en ulempe', en: 'a disadvantage', type: 'substantiv', gender: 'en', example: 'Den største ulempen er de høye prisene.', exampleEn: 'The biggest disadvantage is the high prices.', level: 'B1', topic: 'meninger' },
  ...
  // ───────────────────────── B1 · helse ─────────────────────────
  { id: 'v093', no: 'en fastlege', en: 'a GP (regular doctor)', type: 'substantiv', gender: 'en', example: 'Alle som bor i Norge, har rett til en fastlege.', exampleEn: 'Everyone living in Norway has the right to a GP.', level: 'B1', topic: 'helse' },
  { id: 'v094', no: 'en resept', en: 'a prescription', type: 'substantiv', gender: 'en', example: 'Legen skrev ut en resept på antibiotika.', exampleEn: 'The doctor wrote a prescription for antibiotics.', level: 'B1', topic: 'helse' },
  { id: 'v095', no: 'en sykemelding', en: 'a sick note', type: 'substantiv', gender: 'en', example: 'Hun fikk sykemelding i to uker.', exampleEn: 'She got a sick note for two weeks.', level: 'B1', topic: 'helse' },
  { id: 'v096', no: 'en legevakt', en: 'an emergency clinic', type: 'substantiv', gender: 'en', example: 'Vi måtte dra på legevakten midt på natten.', exampleEn: 'We had to go to the emergency clinic in the middle of the night.', level: 'B1', topic: 'helse' },
  ...
  { id: 'v098', no: 'en behandling', en: 'a treatment', type: 'substantiv', gender: 'en', example: 'Behandlingen tar omtrent tre måneder.', exampleEn: 'The treatment takes about three months.', level: 'B1', topic: 'helse' },
  ...
  // ───────────────────────── B1 · utdanning ─────────────────────────
  { id: 'v100', no: 'en utdanning', en: 'an education', type: 'substantiv', gender: 'en', example: 'Hun tar utdanning som sykepleier.', exampleEn: 'She is training to be a nurse.', level: 'B1', topic: 'utdanning' },
  { id: 'v101', no: 'en barnehage', en: 'a kindergarten', type: 'substantiv', gender: 'en', example: 'De fleste barn i Norge går i barnehage.', exampleEn: 'Most children in Norway attend kindergarten.', level: 'B1', topic: 'utdanning' },
  { id: 'v102', no: 'en videregående skole', en: 'an upper secondary school', type: 'substantiv', gender: 'en', example: 'Etter ungdomsskolen begynner de fleste på videregående.', exampleEn: 'After lower secondary, most start upper secondary school.', level: 'B1', topic: 'utdanning' },
  ...
  { id: 'v105', no: 'en prøve', en: 'a test / exam', type: 'substantiv', gender: 'en', example: 'Jeg skal ta norskprøven til våren.', exampleEn: 'I am taking the Norwegian test in the spring.', level: 'B1', topic: 'utdanning' },
  ...
  { id: 'v108', no: 'et forsøk', en: 'an attempt', type: 'substantiv', gender: 'et', example: 'Det var et godt forsøk, men prøv igjen.', exampleEn: 'It was a good attempt, but try again.', level: 'B1', topic: 'utdanning' },
  ...
  { id: 'v117', no: 'en regning', en: 'a bill / invoice', type: 'substantiv', gender: 'en', example: 'Jeg betaler regningene i nettbanken.', exampleEn: 'I pay the bills in the online bank.', level: 'B1', topic: 'økonomi' },
  ...
  { id: 'v119', no: 'et lån', en: 'a loan', type: 'substantiv', gender: 'et', example: 'De tok opp lån i banken for å kjøpe hus.', exampleEn: 'They took out a bank loan to buy a house.', level: 'B1', topic: 'økonomi' },
  ...
  { id: 'v121', no: 'en forsikring', en: 'an insurance', type: 'substantiv', gender: 'en', example: 'Har du forsikring på bilen?', exampleEn: 'Do you have insurance on the car?', level: 'B1', topic: 'økonomi' },
  { id: 'v122', no: 'en avgift', en: 'a fee / duty / charge', type: 'substantiv', gender: 'en', example: 'Det er høye avgifter på bensin i Norge.', exampleEn: 'There are high duties on petrol in Norway.', level: 'B1', topic: 'økonomi' },
  ...
  { id: 'v124', no: 'et vedtak', en: 'a (formal) decision', type: 'substantiv', gender: 'et', example: 'Kommunen fattet et vedtak om ny skole.', exampleEn: 'The municipality made a decision about a new school.', level: 'B1', topic: 'økonomi' },
  ...
  { id: 'v129', no: 'en forutsetning', en: 'a prerequisite / precondition', type: 'substantiv', gender: 'en', example: 'Godt språk er en forutsetning for å delta i arbeidslivet.', exampleEn: 'Good language skills are a prerequisite for taking part in working life.', level: 'B2', topic: 'samfunn' },
  ...
  { id: 'v131', no: 'et hensyn', en: 'a consideration / regard', type: 'substantiv', gender: 'et', example: 'Vi må ta hensyn til naboene.', exampleEn: 'We must be considerate of the neighbours.', level: 'B2', topic: 'samfunn' },
  ...
  { id: 'v133', no: 'en utfordring', en: 'a challenge', type: 'substantiv', gender: 'en', example: 'Eldrebølgen er en stor utfordring for velferdsstaten.', exampleEn: 'The ageing population is a major challenge for the welfare state.', level: 'B2', topic: 'samfunn' },
  ...
  { id: 'v135', no: 'en utvikling', en: 'a development', type: 'substantiv', gender: 'en', example: 'Utviklingen i boligprisene bekymrer mange.', exampleEn: 'The development in housing prices worries many.', level: 'B2', topic: 'samfunn' },
  ...
  { id: 'v137', no: 'et inntrykk', en: 'an impression', type: 'substantiv', gender: 'et', example: 'Jeg fikk et godt inntrykk av den nye kollegaen.', exampleEn: 'I got a good impression of the new colleague.', level: 'B2', topic: 'meninger' },
  { id: 'v138', no: 'en sammenheng', en: 'a connection / context', type: 'substantiv', gender: 'en', example: 'Det er en klar sammenheng mellom utdanning og lønn.', exampleEn: 'There is a clear connection between education and salary.', level: 'B2', topic: 'meninger' },
  ...
  { id: 'v141', no: 'et synspunkt', en: 'a point of view', type: 'substantiv', gender: 'et', example: 'Jeg forstår synspunktet ditt, men jeg er uenig.', exampleEn: 'I understand your point of view, but I disagree.', level: 'B2', topic: 'meninger' },
  ...
  { id: 'v143', no: 'en årsak', en: 'a cause / reason', type: 'substantiv', gender: 'en', example: 'Hva er årsaken til at prisene stiger?', exampleEn: 'What is the cause of the rising prices?', level: 'B2', topic: 'meninger' },
  { id: 'v144', no: 'en konsekvens', en: 'a consequence', type: 'substantiv', gender: 'en', example: 'Beslutningen fikk store konsekvenser for de ansatte.', exampleEn: 'The decision had major consequences for the employees.', level: 'B2', topic: 'meninger' },
  ...
  { id: 'v149', no: 'et tiltak', en: 'a measure / initiative', type: 'substantiv', gender: 'et', example: 'Regjeringen innfører nye tiltak mot arbeidsledighet.', exampleEn: 'The government is introducing new measures against unemployment.', level: 'B2', topic: 'samfunn' },
  { id: 'v150', no: 'en holdning', en: 'an attitude', type: 'substantiv', gender: 'en', example: 'Han har en positiv holdning til endringer.', exampleEn: 'He has a positive attitude towards change.', level: 'B2', topic: 'meninger' },
  ...
  { id: 'v152', no: 'en erstatning', en: 'a compensation / replacement', type: 'substantiv', gender: 'en', example: 'Han fikk erstatning etter ulykken.', exampleEn: 'He received compensation after the accident.', level: 'B2', topic: 'samfunn' },
  ...
  { id: 'v154', no: 'et vilkår', en: 'a condition / term', type: 'substantiv', gender: 'et', example: 'Les vilkårene nøye før du skriver under.', exampleEn: 'Read the terms carefully before you sign.', level: 'B2', topic: 'økonomi' },
  ...
  { id: 'v156', no: 'et flertall', en: 'a majority', type: 'substantiv', gender: 'et', example: 'Et flertall på Stortinget stemte for forslaget.', exampleEn: 'A majority in Parliament voted for the proposal.', level: 'B2', topic: 'samfunn' },
  { id: 'v157', no: 'et mindretall', en: 'a minority', type: 'substantiv', gender: 'et', example: 'Mindretallet var sterkt imot forslaget.', exampleEn: 'The minority was strongly against the proposal.', level: 'B2', topic: 'samfunn' },
